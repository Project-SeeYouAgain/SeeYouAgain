...
import { productState, userState, reservationIdState, reviewState } from '../../../recoil/user/atoms';
...
function Redirect() {
    ...
    const [reviewData, setReviewData] = useRecoilState<ReviewState>(reviewState);
